...
-- 0 null values in date_published column
...
WHERE
    languages IS NULL;
-- 194 null values in languages column
...
-- id, title, year, date_published and duration are the 5 columns with no null values.
-- country, worldwide_gross_income, languages and production_company are the columns with 20, 3724, 194 and 528 null values respectively.
...
SELECT genre,
	...
	ORDER BY
		genre ROWS 10 PRECEDING) AS moving_avg_duration
FROM
	movie AS m 
INNER JOIN
	genre AS g 
